...
public class BibliotecarioFacadeREST extends AbstractFacade<Bibliotecario> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Bibliotecario entity) {
        super.edit(entity);
    }
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Bibliotecario> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
